...
FIRST_RUN="${XDG_CONFIG_HOME}/flatpak-vscode-insiders-first-run"
...
# Add tool extensions to PATH and PYTHONPATH
...
# Enable SDK extensions (e.g. FLATPAK_ENABLE_SDK_EXT=dotnet,golang)
...
# Provide /etc/shells from host if not present in sandbox
